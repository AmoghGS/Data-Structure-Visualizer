...
.then(response => {
    ...
    coordinates.push(JSON.parse(response))
...
class Canvas extends React.Component {
    ...
    render() {
        ...
        return (
            <div className="d1">
                <canvas ref={this.canvasRef} {...this.props} className="canvas" style={mystyle} /><br />
                <div style={{ float: 'left', marginLeft: '50px' }}>
                    Enter the Element:  <input type="text" ref={(el) => { this.elementRef = el }}></input>
                    <br />
                    Enter the position: <input type="text" ref={(el) => { this.posRef = el }} defaultValue="1"></input>
                    <br />
